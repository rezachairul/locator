...
<tr class="text-gray-700 dark:text-gray-400">
    ...
    <td class="px-2 py-1 text-xs text-center">
        <div class="flex justify-center space-x-2">
            @if ($user->email === 'admin.admin@locatorgis.test' || $user->email === 'operator.operator@locatorgis.test')
                <!-- Disable Edit & Delete untuk akun default -->
                <span class="text-gray-400 hover:text-purple-600 transition-colors duration-200" title="Deafult Account">
                    ...
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                        ...
                        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <div class="flex justify-center items-center space-x-4">
                                @if (isset($user))
                                <form action="{{ route('admin.operator.destroy', $user->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
