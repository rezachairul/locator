...
<div id="defaultModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.operasional.weather.store') }}" method="post">
                @csrf
                <div class="mt-2 mb-4 sm:col-span-2">
                    <div class="mt-2 mb-4">
                        <label for="cuaca"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cuaca</label>
                        <select id="cuaca"name="cuaca" onchange="ubahGambarCuaca()"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option selected="#" value="#">Pilih Cuaca</option>
                            <option value="cerah">Cerah</option>
                            <option value="cerah_berawan">Cerah Berawan</option>
                            <option value="berawan">Berawan</option>
                            <option value="berawan_tebal">Berawan Tebal</option>
                            ...
                            <option value="hujan_petir">Hujan Petir</option>
                            <option value="kabut">Kabut</option>
                        </select>
                    </div>
                    <div class="mt-2 mb-4">
                        <label for="curah_hujan" id="dropdownDefaultButton" data-dropdown-toggle="dropdown"class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Curah Hujan</label>
                        <input type="text" name="curah_hujan" id="curah_hujan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Data Cuaca" required="">
                    </div>                    
                </div>
