    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        <div class="w-full overflow-x-auto">
            <table class="whitespace-nowrap table-auto min-w-full">
                ...
                <tbody id="exca-tbody" class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @include('admin.operasional.exca.partials.table_body')
                </tbody>
            </table>
        </div>
        <!-- Pagination & Showing -->
        ...
        @include('admin.operasional.exca.create')
        @include('admin.operasional.exca.update')
    </div>
</x-admin.layouts>