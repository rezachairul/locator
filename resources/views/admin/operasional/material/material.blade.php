    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="flex flex-1">
                <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                    ...
                    <input id="search-input" type="text"
                        ...
                        data-url="{{ route('admin.operasional.material.index') }}"
                        data-target="material-tbody"
        ...
        <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody id="material-tbody" class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @include('admin.operasional.material.partials.table_body')
                </tbody>
            </table>
            <!-- Pagination & Showing -->
        ...
        <!-- modals create -->
        @include('admin.operasional.material.create')
        @include('admin.operasional.material.update')
    </div>
    <br>
</x-admin.layouts>