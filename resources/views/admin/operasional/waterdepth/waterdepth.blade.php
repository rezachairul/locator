    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="flex flex-1 lg:mr-32">
                <div class="relative w-full max-w-xl">
                    ...
                    <input id="search-input" type="text"
                        ...
                        data-url="{{ route('admin.operasional.waterdepth.index') }}"
                        data-target="waterdepth-tbody"
        ...
        <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody id="waterdepth-tbody" class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @include('admin.operasional.waterdepth.partials.table_body')
                </tbody>
            </table>
            <!-- Pagination & Showing-->
        ...
        @include('admin.operasional.waterdepth.create')
        @include('admin.operasional.waterdepth.update')
    </div>
</x-admin.layouts>