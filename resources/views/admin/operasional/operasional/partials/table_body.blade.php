...
<tr class="text-gray-700 dark:text-gray-400">
    ...
    <td class="px-2 py-1 text-xs text-center">
        <div class="flex justify-center space-x-4">
            <!-- Edit -->
            <button id="updateProductButton-{{ $operasional->id }}" data-modal-target="updateProductModal-{{ $operasional->id }}" data-modal-toggle="updateProductModal-{{ $operasional->id }}" type="button"
            ...
            <!-- Delete -->
            <button id="deleteButton-{{ $operasional->id }}" data-modal-target="deleteModal-{{ $operasional->id }}" data-modal-toggle="deleteModal-{{ $operasional->id }}" type="button"
                ...
                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                    ...
                    <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <div class="flex justify-center items-center space-x-4">
                            ...
                            <form action="{{route('admin.operasional.operasional.destroy', $operasional->id)}}" method="post">
                                @method ('DELETE')
                                @csrf
