        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{route('maps.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-2 mb-4 sm:col-span-2">
                    <div>
                        <label for="fileName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama File</label>
                        ...
                        <div class="flex items-center justify-center w-full sm:col-span-2">
                            <label for="file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 ">
                                <div class="flex flex-col text-sm font-medium items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">add .ecw format</p>
                                </div>
