...
<body> 
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Assuming you have a mechanism to switch themes, you should add an event listener to detect theme changes.
            // Example: when a button is clicked to change the theme
