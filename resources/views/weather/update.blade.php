                ...
                <div class="mt-2 mb-4 sm:col-span-2">
                    <div class="mt-2 mb-4">
                        ...
                        <select id="cuaca"
                            ...
                            <option selected="">Cerah</option>
                            <option value="#">Cerah Berawan</option>
                            <option value="#">Berawan</option>
                            <option value="#">Berawan Tebal</option>
                            <option value="#">Hujan Ringan</option>
                            <option value="#">Hujan Sedang</option>
                            <option value="#">Hujan Lebat</option>
                            <option value="#">Hujan Petir</option>
                            <option value="#">Kabut</option>
                        </select>
                    </div>
                    <div class="mt-2 mb-4">
                        <label for="curah_hujan" id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                        ...
                        <input type="text" name="curah_hujan" id="curah_hujan"
                            ...
                            placeholder="Dalam Milimeter" required="">
                    </div>
                </div>
                <button type="submit"
